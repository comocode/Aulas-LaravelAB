...
@section('content')
    <div class="uk-grid" data-uk-grid-margin>
        ...
        <div class="uk-width-medium-1-4">
            ...
            @ab("Livro de Destaque')

            @condition('Desenho Novo')
            <div class="uk-painel uk-painel-box">
                <h1 class="titulo"> Destaque Livro </h1>
                <hr>
                <a href="{{url('/destaque')}}"
                   class="uk-button uk-button-large uk-button-primary"> Meu Livro </a>
                <h3> Comocode Books </h3>
            </div>

            @condition('Desenho Original')
            <h1> Destaque Livro </h1>
            <hr>
            <h2> <a href="{{url('/destaque')}}" > Meu Livro </a> </h2>
            <h3> Comocode Books </h3>

            @track('Pagina do Livro de Destaque')
